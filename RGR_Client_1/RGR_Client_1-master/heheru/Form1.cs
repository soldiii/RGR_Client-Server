...
namespace heheru
{
    public partial class Form1 : Form
    {
        ...
        private void AddVacancy(int idVacancy,string Description,string NameVacancy,string formatedforsql,string salaryCurrency,int? salaryFrom,int? salaryTo,string SnippetRequirement,string SnippetResponsibility,int idArea, string idExpirience )
        {
        ...
        private void fill_Click(object sender, EventArgs e)
        {
            ...
            foreach(dynamic item in d.items)
            {
                ...
                dynamic v = JsonConvert.DeserializeObject(ln,setts);
